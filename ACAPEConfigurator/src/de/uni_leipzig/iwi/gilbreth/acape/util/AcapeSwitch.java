...
public class AcapeSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AcapePackage.ACAPE_DATA_MODEL: {
				ACAPEDataModel acapeDataModel = (ACAPEDataModel)theEObject;
				T result = caseACAPEDataModel(acapeDataModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcapePackage.ENTITY: {
				Entity entity = (Entity)theEObject;
				T result = caseEntity(entity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcapePackage.ATTRIBUTE: {
			...
			case AcapePackage.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AcapePackage.FEATURE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>ACAPE Data Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>ACAPE Data Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseACAPEDataModel(ACAPEDataModel object) {
		return null;
	}
