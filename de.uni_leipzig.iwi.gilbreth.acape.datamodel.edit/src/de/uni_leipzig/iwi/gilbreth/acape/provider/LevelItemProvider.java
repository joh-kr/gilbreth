...
/**
 * This is the item provider adapter for a {@link de.uni_leipzig.iwi.gilbreth.acape.Level} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LevelItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AcapePackage.Literals.LEVEL__FEATURES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Level.class)) {
			case AcapePackage.LEVEL__FEATURES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AcapePackage.Literals.LEVEL__FEATURES,
				 AcapeFactory.eINSTANCE.createFeature()));
	}
