...
/**
 * This is the item provider adapter for a {@link de.uni_leipzig.iwi.gilbreth.VBPODataModel.vbpodatamodel.Product} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addUnitCostPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Product_unitCost_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Product_unitCost_feature", "_UI_Product_type"),
				 VbpodatamodelPackage.Literals.PRODUCT__UNIT_COST,
				 true,
				 false,
				 false,
