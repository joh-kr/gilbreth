...
/**
 * This is the item provider adapter for a {@link de.uni_leipzig.iwi.gilbreth.VBPODataModel.vbpodatamodel.Competitor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompetitorItemProvider
	 ...
	 * @generated
	 */
	public CompetitorItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Competitor"));
	}
	...
	public String getText(Object object) {
		String label = ((Competitor)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Competitor_type") :
			getString("_UI_Competitor_type") + " " + label;
	}
