...
import acape.Constraint;
import acape.ConstraintType;
...
/**
 * This is the item provider adapter for a {@link acape.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AcapePackage.Literals.CONSTRAINT__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addLhsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_lhs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_lhs_feature", "_UI_Constraint_type"),
				 AcapePackage.Literals.CONSTRAINT__LHS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRhsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_rhs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_rhs_feature", "_UI_Constraint_type"),
				 AcapePackage.Literals.CONSTRAINT__RHS,
				 true,
				 false,
				 true,
				 null,
