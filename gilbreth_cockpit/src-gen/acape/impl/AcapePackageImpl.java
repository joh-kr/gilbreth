...
public class AcapePackageImpl extends EPackageImpl implements AcapePackage {
	 ...
	 * @see acape.AcapePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EAttribute getACAPEDataModel_Name() {
		return (EAttribute)acapeDataModelEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getACAPEDataModel_Attributes() {
		return (EReference)acapeDataModelEClass.getEStructuralFeatures().get(1);
	}
